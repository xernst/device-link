#!/usr/bin/env bash
# Start the right-brain agent swarm in tmux.
set -euo pipefail
...
tmux send-keys -t "$SESSION:tasks" "echo 'Right brain ready. Waiting for tasks...'" C-m
...
echo "Right brain started. Session: $SESSION"
